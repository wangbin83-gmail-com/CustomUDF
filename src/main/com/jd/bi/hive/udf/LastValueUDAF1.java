...
@WindowFunctionDescription(description = @Description(name = "wy_last_value", value = "_FUNC_(x)"), supportsWindow = true, pivotResult = false, impliesOrder = true)
public class LastValueUDAF1 extends AbstractGenericUDAFResolver
{
	static final Log LOG = LogFactory.getLog(LastValueUDAF1.class
			.getName());
...
//			}
//
//			if (parameters[0] == null && lb.val == null) {
//				LOG.info("both is null");
//				lb.val = 0;
